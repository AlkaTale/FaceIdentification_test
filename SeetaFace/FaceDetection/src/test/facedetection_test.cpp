...
int main(int argc, char** argv) {
  ...
  //const char* img_path = argv[1];
	const char* img_path = "D:/study/seetaface/Detection/data/0_1_1.jpg";
  //seeta::FaceDetection detector(argv[2]);
	seeta::FaceDetection detector("D:/study/seetaface/Detection/model/seeta_fd_frontal_v1.0.bin");
